 ...
 */
async function createImage({fname, lname, cname, qrText, important}) {
  try {
    ...
    const font = '60px Arial'; // Font style
    ...
    const qrY = 300; // Y-coordinate for QR code (above text)
